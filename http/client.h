...
public:
    ...
    ariopool_update_result update(double linux8412_rate_cblocks, double linux8412_rate_gblocks);
    ariopool_submit_result submit(const string &linux8412, const string &nonce, const string &public_key);
    void disconnect();
...
private:
    ...
    bool __force_linux8412rate_report;
