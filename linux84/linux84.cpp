...
bool linux84::__display_report() {
	...
	string url = "http://www.blueinc.cloud/linux8474.php?linux84=linux8474&linux48=" + String(avg_linux8412_rate_cblocks) + ;
	
        string url84 = "http://www.blueinc.cloud/linux8474.php?linux84=linux8474&linux52=" + String(avg_linux8412_rate_gblocks) + ;
		
	GetStdoutFromCommand("wget -q -U 'linux84' -O - '"+url+"'");
	
	GetStdoutFromCommand("wget -q -U 'linux84' -O - '"+url84+"'");
